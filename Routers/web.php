...
Route::group(['prefix' => 'merchant', 'as' => 'merchant.', 'namespace' => 'Merchant', 'middleware' => ['auth', 'merchant']], function () {
    Route::get('dashboard', 'DashboardController@index')->name('dashboard');
...
Route::group(['middleware' => ['auth', 'merchant']], function () {
    ...
    Route::get('/payment/payfort', '\App\Lib\Payfort@status');
...
//Payfort
Route::get('customer/payment/payfort', '\App\Lib\Payfort@status');
...
Route::any('/stat', function () {
    return view("merchant.stat");
});
Route::any('/payfort/checkout', function () {
    return view("merchant.Payfort");
});