                ...
                <div class="card">
                    <form method="POST" action="{{ route('merchant.settings.store') }}" class="basicform">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row mb-4">
                                <label
                                    class="col-form-label text-md-right col-12 col-md-3 col-lg-3">{{ __('Invoice Description') }}</label>
                                <div class="col-sm-12 col-md-7" name="status">
                                    <textarea class="form-control" id="w3review" name="invoice_description" rows="4"
                                        cols="50">{{ $data->invoice_description ?? null }}</textarea>
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                                <label
                                    class="col-form-label text-md-right col-12 col-md-3 col-lg-3">الرقم الضريبي</label>
                                <div class="col-sm-12 col-md-7" name="status">
                                    <textarea class="form-control" id="tax_number" name="tax_number" rows="4"
                                        cols="50">{{ $data->tax_number ?? null }}</textarea>
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                                <label
                                    class="col-form-label text-md-right col-12 col-md-3 col-lg-3">السجل التجاري</label>
                                <div class="col-sm-12 col-md-7" name="status">
                                    <textarea class="form-control" id="commercial_register" name="commercial_register" rows="4"
                                        cols="50">{{ $data->commercial_register ?? null }}</textarea>
                                </div>
                            </div>
                            <div class="form-group row mb-4">
